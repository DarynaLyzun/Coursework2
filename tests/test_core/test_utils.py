...
def test_get_temperature_label(temp, expected_label):
    """Verifies correct temperature label mapping."""
    assert get_temperature_label(temp) == expected_label


@pytest.mark.parametrize(
    "humidity, expected_label",
    [(25, "Dry"), (30, "Comfortable"), (50, "Comfortable"), (60, "Humid"), (80, "Humid")],
)
def test_get_humidity_label(humidity, expected_label):
    """Verifies correct humidity label mapping."""
    assert get_humidity_label(humidity) == expected_label


@pytest.mark.parametrize(
    "speed, expected_label",
    [
        (0.0, "Calm"),
        (0.5, "Calm"),
        (1.0, "Light Breeze"),
...
def test_get_wind_label(speed, expected_label):
    """Verifies correct wind speed label mapping."""
